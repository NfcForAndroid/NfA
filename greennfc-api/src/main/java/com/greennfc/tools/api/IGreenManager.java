...
public interface IGreenManager {
	...
	<Record extends IGreenRecord> void writeTag(Context context, Intent intent, IGreenIntentWrite recieve, boolean addAndroidApplicationRecord, GreenWriteBean<Record>... writers);
