...
public abstract class AbstractNfaRecordNdefFacory implements INfaRecordNdefFactory {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.nfa.tools.records.factory.INfaRecordNdefFactory#ndefRecord(short, byte[], byte[], byte[])
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.nfa.tools.records.factory.INfaRecordNdefFactory#ndefRecord(android.nfc.NdefRecord)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.nfa.tools.records.factory.INfaRecordNdefFactory#mimeRecordInstance(java.lang.String, byte[])
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.nfa.tools.records.factory.INfaRecordNdefFactory#mimeRecordInstance(java.lang.String, java.io.InputStream)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.nfa.tools.records.factory.INfaRecordNdefFactory#unknownRecordInstance(byte[])
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.nfa.tools.records.factory.INfaRecordNdefFactory#unsupportedRecord(short, byte[], byte[], byte[])
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.nfa.tools.records.factory.INfaRecordNdefFactory#unsupportedRecord(android.nfc.NdefRecord)
	 */
